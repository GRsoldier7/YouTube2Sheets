...
class YouTube2SheetsGUI:
    ...
    def _build_link_sync_tab(self, parent):
        ...
        help_text = """Enter the YouTube channel you want to sync videos from:

• @channelhandle (e.g., @mkbhd)
• Full URL (e.g., https://youtube.com/@mkbhd) 
• Channel ID (e.g., UCBJycsmduvYEL83R_U4JriQ)

This is the SOURCE channel - all its videos will be synced to your Google Sheet."""
        ...
        ctk.CTkLabel(
            quota_frame,
            text="ℹ️ This tracks our internal API usage, not your YouTube account quota",
